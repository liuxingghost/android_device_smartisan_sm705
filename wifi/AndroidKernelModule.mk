...
ifeq ($(KBUILD_FILE),)
  KBUILD_FILE := $(MODULE_PATH)/Kbuild
endif
...
KBUILD_OUT_DIR := $(TARGET_OUT_INTERMEDIATES)/$(MODULE_PATH)
...
$(KBUILD_MODULE): module_name := $(LOCAL_MODULE_KBUILD_NAME)
$(KBUILD_MODULE): module_path     := $(MODULE_PATH)
...
ifneq "$(LOCAL_MODULE_KBUILD_NAME)" ""
	mv -f $(KERNEL_OUT)/../../../$(module_path)/$(module_name) $@
endif
...
.PHONY: $(KBUILD_TARGET)
$(KBUILD_TARGET): module_path     := $(MODULE_PATH)
...
$(KBUILD_TARGET): $(TARGET_PREBUILT_INT_KERNEL)
	...
	$(hide) cp -f $(module_path)/Kbuild $(kbuild_out_dir)/Kbuild
	$(MAKE) $(MAKE_FLAGS) -C $(KERNEL_OUT) M=../../../$(module_path) O=$(KERNEL_OUT) ARCH=$(TARGET_ARCH) $(ARM_CROSS_COMPILE) modules $(kbuild_options)
